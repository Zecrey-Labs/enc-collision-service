...
docker run --name zecreypostgres -p 5432:5432 -e POSTGRES_DB=zecrey -e POSTGRES_USER=root -e POSTGRES_PASSWORD=123456  -d ghcr.io/zecrey-labs/zecrey-postgres-sample:0.0.3
# redis
docker pull ghcr.io/tygavinzju/redis-sample:1.0.0
docker run -itd --name redis-test -p 6379:6379 //注意端口不要重复 ghcr.io/tygavinzju/redis-sample:1.0.0
